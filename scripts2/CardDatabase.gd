const CARDS = { # mana, cout social, cout env., dommage, description de la carte]
	"Eolapino" : [3, 12, 2, 10, "Construction d'un champs d'Eolapinos, ils produisent un peu d'électricité grâce au vent tout en réduisant la quantité de monstres polluants apparaissant sur la planète."],
