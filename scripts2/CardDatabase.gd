const CARDS = { # mana, cout social, cout env., dommage, description de la carte]
	...
	"Taxito Gratuito" : [2, 1, 21, 0, "Les taxis sont dorénavant gratuit et les conducteurs sont rémunérés par le gouvernement pour des voyages plus pratique, mais contribuant un peu à la satisfaction des monstres."],
	"Climato Froido" : [2, 2, 22, 0, "Subvention du gouvernement pour des climatiseurs gratuits pour tout le monde qui permettent à tout le monde de vivre dans un grand confort au prix de l'environnement."],
