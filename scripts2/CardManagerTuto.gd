...
var enemy_reference
var mana_reference
var envsoc_gauge_reference


func _ready() -> void:
	screen_size = get_viewport_rect().size
	player_hand_reference = $"../PlayerHand"
	enemy_reference = $"../EnemyTuto"
	mana_reference = $"../Mana"
	envsoc_gauge_reference = $"../EnvSocGauge"
	$"../InputManagerTuto".connect("left_mouse_button_released", on_left_click_released)
...
func start_drag(card):
	if Global.monster_turn or Global.stop_drag_card:
		pass
	else:
...
func finish_drag():
	...
	if enemy_found:
		if int(card_being_dragged.get_node("ManaCost").text) <= int(mana_reference.mana):
...
func raycast_check_for_enemy():
	...
	parameters.collision_mask = COLLISION_MASK_CARD_ENEMY
